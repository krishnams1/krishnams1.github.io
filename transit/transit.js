    ...
    for(key in TStationsLookup)
    {
        if(line_color == TStationsLookup[key].Line)
        {
          ...
          curMarker['infoWindow'] = new google.maps.InfoWindow({
            content: "This Station is: "+TStationsLookup[key].Station+"<br> Predictions: <br><br>"+"Destination&nbsp;&nbsp;&nbsp;Time <br>Alewife   0min 16s <br>Ashmont   19min 47s <br>Alewife   19min 16s <br>Ashmont   5min 59s <br>"
          });
